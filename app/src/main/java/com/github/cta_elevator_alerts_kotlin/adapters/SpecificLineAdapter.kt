...
class SpecificLineAdapter(private val specificLineListener: SpecificLineListener): ListAdapter<Station, SpecificLineAdapter.ViewHolder>(SpecificLineStationDiffCallback()) {

    class ViewHolder private constructor(val binding: SpecificLineStationBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Station, specificLineListener: SpecificLineListener){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bind(getItem(position), specificLineListener)
    }
}
